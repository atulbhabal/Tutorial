<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="AddDistributor.aspx.cs" Inherits="AddDistributor" %>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>
                                        Distributor Master<small></small>
                                    </h5>
                                ...
                                <div class="ibox-content">
                                    <div method="get" class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvOrderBy" runat="server" ValidationGroup="ordersubmit"
                                                    ControlToValidate="txtDistributorName" ForeColor="Red" ErrorMessage="Please enter distributor name.">
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="gvDistributor" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover dataTables-example"
                                                OnRowEditing="gvDistributor_RowEditing" OnRowUpdating="gvDistributor_RowUpdating"
                                                OnRowCancelingEdit="gvDistributor_RowCancelingEdit">
                                                <Columns>
